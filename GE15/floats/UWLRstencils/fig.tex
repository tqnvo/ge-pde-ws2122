\begin{figure}[ht]
	...
	\includegraphics[width=0.84\textwidth]{UWLRstencils.eps}
	\caption{\emph{Upwind} scheme: In case of $a>0$
		the scheme whose stencils are pointing to the left (Case 1 in \rFig{a4casesupwind})
		is the suitable choice, compared to
		the case whose stencils are pointing to the right (Case 4 in \rFig{a4casesupwind}).}
	\label{\LABEL}
\end{figure}
