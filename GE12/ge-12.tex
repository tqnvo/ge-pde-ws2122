...
\subsection{Numerical DoD and Analytical DoD}
\begin{example}
	Examine the numerical domain of dependence of the One-sided method.
\end{example}
...
\begin{enumerate}
	\item Perspective of index\\
	      ...
	      and then taking the limit $\Delta t \rightarrow 0$ we obtain
	      the entire set, as follows 
	      \begin{align}
		      \lim_{\Delta t \rightarrow 0}\mathcal{D}_{\Delta t}\left(x_j,t_n\right)
