...
\begin{enumerate}
	\item Perspective of indical subscription:\\
	      ...
	      under line $(l_1)$ and $(l_2)$, as shown in \rFig{DomainOfDependence}.
...
\begin{enumerate}
	\item Point $E$ in terms of fixed-point value satisfying
	      \begin{align}
		      t = t_n + \frac{t_{n-1}-t_n}{x_{j+1}-x_j}\left(x-x_{j}\right)
	      \end{align}
...
\begin{example}\label{eq:example3}
	Examine the numerical domain of dependence for a three-point scheme.
\end{example}
