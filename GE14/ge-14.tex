...
\begin{document}
\begin{center}
	\section*{Global Exercise - 14}
\end{center}
\begin{center}
	Tuan Vo
\end{center}
\begin{center}
	$25^{\text{th}}$ January 2022
\end{center}
...
\begin{align}
	...
	+\frac{1}{2}f(u_{j+1}^{n})
\end{align}
However, these numerical flux function $\widetilde{f}(\cdot,\cdot)$
is not consistent with the original flux function $f(\cdot)$, which 
can be checked $\forall \beta \in \mathbb{R}$ as follows
\begin{align}
