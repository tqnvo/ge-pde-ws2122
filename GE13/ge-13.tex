...
\begin{figure}[ht]
	\centering
	% \animategraphics[scale=0.3,every=2,autoplay,loop]{1}{animations/sqn_lipschitz/lipschitz-}{1}{51}
	% \movie[height = 0.6\textwidth,width = 0.8\textwidth]{}{movies/lipschitz/lipschitz.mpg}
	\movie[height = 0.5\textwidth,width = 0.5\textwidth, poster]{}{movies/lipschitz/lipschitz.mpg}
	\caption{Lipschitz continuity.}
\end{figure}
